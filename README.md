...
**Implement:**
Implementation will be completed in Phase III on branch:
...
**Review:**
Review the implementation against the project's CONTRIBUTING.md guidelines and existing UI patterns.

**Evaluate:**
Confirm that all operation filter entries are visible and selectable, verify that scrolling works correctly, and ensure no regressions are introduced elsewhere in the Insights page.
